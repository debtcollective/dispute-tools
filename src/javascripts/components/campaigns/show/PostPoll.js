/* eslint-disable no-console, no-unused-vars, max-len, arrow-body-style */
import Widget from '../../../lib/widget';

export default class PostPoll extends Widget {
  constructor(config) {
    super(config);
    console.log('Poll');
  }
      ...
      <div class="Campaign_FeedItem -bg-white p2">
        <div class="flex relative">
          ...
          <div class="flex-auto pl2">
            ...
            <p class="pb2">${data.data.title}</p>
            <form>
              ${data.data.options.map(option => this._label(option)).join('')}
            </form>
