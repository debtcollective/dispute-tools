...
export default class CommentsManager extends Widget {
  ...
  _bindEvents() {
    ...
    this.ToggleCommentsButton.element.addEventListener(
      'click',
      this._handleToogleComments,
    );
  ...
  _handleToogleComments() {
    ...
    this.ToggleCommentsButton.element.setAttribute(
      'aria-expanded',
      this.expandedComments,
    );
    this.CommentList.element.setAttribute(
      'aria-expanded',
      this.expandedComments,
    );
