<template>
  <div>
    <div :class="`col col-${typeSelected === 'other' ? '4' : '8'} py2 pr2`">
      ...
      <div class="-k-select">
        <select class="-fw" @input="handleTypeSelection" :value="typeSelected" :name="typeSelected !== 'other' ? 'fieldValues[debt-type]' : 'debt-type[other]'" aria-labelledby="debt-type-l">
    ...
    <div v-if="typeSelected === 'other'" class="col col-4 p2">
      ...
      <input type="text" class="-k-input -fw" placeholder="..." name="fieldValues[debt-type]" aria-labelledby="other-debt-type-l" v-model="type" />
    </div>
