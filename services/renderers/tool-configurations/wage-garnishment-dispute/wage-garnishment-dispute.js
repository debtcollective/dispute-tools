// Maps the user-input responses to the fields in the wage garnishment PDF form. Note that a lot of the PDF form's field names are long and weird.
...
module.exports = {
  templates: [
    new DisputeTemplate({
      ...
      normalize({ disputeProcess, disputeProcessCity, option, forms: { 'personal-information-form': form } }) {
        const basicInfo = {
          borr_name: form.name,
        ...
        const disputeProcessInfo = this.data.fillDisputeProcessFields(disputeProcess, disputeProcessCity, form);
