...
module.exports = {
  templates: [new DisputeTemplate({
    ...
    normalize({ forms: { 'personal-information-form': form } }) {
      const address2 = form.address2 // fallback to old address collection
        || `${form.city}, ${form.state}, ${form['zip-code']}`;
      const schoolAddress2 = form['school-address2']
      ...
      return Object.assign({}, {
        ...
        [page1('SchoolAddress')]:
          `${form['school-address']}, ${schoolAddress2}`,
