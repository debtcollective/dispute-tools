...
// AWS.config.update({
//   region: 'us-east-1',
//   accessKeyId: process.env.AWS_KEY || CONFIG.env().AWS.accessKeyId,
//   secretAccessKey: process.env.AWS_SECRET || CONFIG.env().AWS.secretAccessKey,
// });

/* BaseMailer */
const transport = nodemailer.createTransport(CONFIG.env().mandrill);
