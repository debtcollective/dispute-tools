const { aws: { bucket, secrets, useSes } } = require('../config/config');
...
// Only set the sesInstance if useSes is true.
// This lets us continue using mailcatcher for local development.
exports.sesInstance = useSes ? new aws.SES({ apiVersion: '2010-12-01' }) : null;
