...
const personalInformationOneA = wageGarnishmentForm();
const personalInformationOneB = wageGarnishmentForm();
const personalInformationOneC = { ...wageGarnishmentForm() };
const personalInformationOneD = { ...wageGarnishmentForm() };
const personalInformationOneE = { ...wageGarnishmentForm() };
...
[
  personalInformationOneA,
  personalInformationOneB,
...
module.exports = {
  ...
  options: {
    A: {
      ...
      steps: [personalInformationOneA, personalStatement, evidenceUploader],
    },
    B: {
