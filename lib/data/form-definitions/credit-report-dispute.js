...
module.exports = {
  ...
  nowWhat: `
    ...
    <br><br>
    We will prompt you to report the results of your dispute so we can make sure our members rights are respected and that errors in their reports are promptly removed.
  `,
  options: {
    none: {
