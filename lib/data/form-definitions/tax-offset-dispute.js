...
const personalInformationAB = Object.assign({}, taxOffsetForm());
const personalInformationC = Object.assign({}, taxOffsetForm());
const personalInformationD = Object.assign({}, taxOffsetForm());
const personalInformationE = Object.assign({}, taxOffsetForm());

personalInformationC.fieldSets.push(atbForm);
personalInformationD.fieldSets.push(atbDisqualifyingForm);
personalInformationE.fieldSets.push(unauthorizedSignatureForm);
...
module.exports = {
  ...
  options: {
    A: {
      ...
      steps: [personalInformationAB, evidenceUploader],
    },
