...
module.exports = {
  ...
  options: {
    A: {
      ...
      steps: [personalInformation, personalStatement, evidenceUploader],
    },
    B: {
      title:
        'I should not have to pay this debt because I was lied to or defrauded by my school.',
      description:
        'See the <a href="#" id="common-cases-toggler-B">common cases</a> of fraud.',
