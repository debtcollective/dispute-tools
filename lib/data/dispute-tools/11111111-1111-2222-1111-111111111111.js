...
const personalInformationA = Object.assign({}, personalInformation);
personalInformationA.fieldSets = personalInformationA.fieldSets.concat(
  {
    title: 'Tax Offset Dispute',
    subtitle: 'Later in this form, you will be asked to select which option you prefer. There is no benefit to choosing one option over the others. It\'s up to you! Unfortunately, the Department of Education makes the ultimate decision on what kind of review you will receive, so you should provide as much evidence as you can on this form in case your request for a telephone or in-person hearing is denied. <br /><strong>CHECK ONLY ONE OF THE FOLLOWING</strong>',
    fields: [
      [
        {
          name: 'tod-section2',
          label: 'This is the part of the dispute where you will explain why you are disputing your federal student debt. Choose the option that best applies to you.',
          fields: [
            [
              {
            ...
            [
              {
                name: 'tod-school-attended-at',
                label: 'When did you attended the school?',
                type: 'date',
                validations: [
                  'required',
                ],
            ...
            [
              {
                ...
                label: 'When I borrowed this guaranteed student loan to attend [school], I had a condition (physical, mental, age, criminal record) that prevented me from meeting State requirements for performing the occupation for which it trained me. For examples, go <a href="http://www.studentloanborrowerassistance.org/loan-cancellation/school-related/false-certification/disqualifying-status/">here.</a> <br />Attach, later when you finish this form, a statement describing in detail the condition that prevented you from using your degree and any supporting documents.',
                type: 'checkbox',
              },
            ],
