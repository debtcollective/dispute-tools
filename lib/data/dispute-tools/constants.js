...
const textToParagraphs = text => {
  ...
  if (text.length > maxLength) {
    ...
    const lastTrimmedSpace = Math.min(
    ...
    [
      {
        ...
        validations: ['required', 'maxLength:152'],
      },
    ],
    [
      {
          ...
          [
            {
              ...
              validations: ['required', 'maxLength:24'],
            },
          ],
          [
            {
  ...
  templates: [
    {
      ...
      fields: {
        ssn(template, data) {
          const result = normalizeSSN(
            data.forms['personal-information-form'].ssn
          );
        ...
        */
        atbApplyingAs(template, data) {
          const value =
            data.forms['personal-information-form']['atb-applying-as'];
        ...
        atbStudentName(template, data) {
          ...
          if (check === 'yes') {
            const value =
              data.forms['personal-information-form']['atb-student-name'];
        ...
        atbStudentSsn(template, data) {
          ...
          if (check === 'yes') {
            const result = normalizeSSN(
              data.forms['personal-information-form']['atb-student-ssn']
            );
        ...
        atbAttendedAt(template, data) {
          const value =
            data.forms['personal-information-form']['atb-attended-at'];
        ...
        atbAttendedWhere(template, data) {
          const value =
            data.forms['personal-information-form']['atb-attended-where'];
        ...
        schoolAddress(template, data) {
          const personalInformationForm =
            data.forms['personal-information-form'];
          const address = personalInformationForm['school-address'];

          // Old records will have school-address2 field
          let address2 = personalInformationForm['school-address2'];

          // New records will have school-city, school-state and school-zip-code fields
          if (!address2) {
            const city = personalInformationForm['school-city'];
            const state = personalInformationForm['school-state'];
            const zip = personalInformationForm['school-zip-code'];
        ...
        atbSchoolDate(template, data) {
          const value =
            data.forms['personal-information-form']['atb-school-date'];
        ...
        schoolFrom(template, data) {
          const value =
            data.forms['personal-information-form']['school-attended-from'];
        ...
        schoolTo(template, data) {
          const value =
            data.forms['personal-information-form']['school-attended-to'];
        ...
        atbReceivedGED(template, data) {
          const value =
            data.forms['personal-information-form']['atb-received-ged'];
        ...
        enrolledAt(template, data) {
          const value =
            data.forms['personal-information-form']['atb-enrolled-at'];
    ...
    },
    {
      ...
      fields: {
        atbEntranceExam(template, data) {
          const value =
            data.forms['personal-information-form']['atb-entrance-exam'];
        ...
        explain(template, data) {
          ...
          const { firstParagraph, secondParagraph } = textToParagraphs(
            text || ''
          );
        ...
        atbEntranceExamSupporterAddress2(template, data) {
          const personalInformationForm =
            data.forms['personal-information-form'];

          // Old records will have address2 field
          let address2 =
            personalInformationForm['atb-entrance-exam-supporter-address2'];

          // New records will have city, state and zip fields
          if (!address2) {
            const city =
              personalInformationForm['atb-entrance-exam-supporter-city'];
            const state =
              personalInformationForm['atb-entrance-exam-supporter-state'];
            const zip =
              personalInformationForm['atb-entrance-exam-supporter-zip-code'];
  ...
  templates: [
    {
      ...
      fields: {
        ...
        atbApplyingAs(template, data) {
          const value =
            data.forms['personal-information-form']['fc-applying-as'];
        ...
        atbStudentName(template, data) {
          ...
          if (check === 'yes') {
            const value =
              data.forms['personal-information-form']['fc-student-name'];
        ...
        atbStudentSsn(template, data) {
          ...
          if (check === 'yes') {
            const result = normalizeSSN(
              data.forms['personal-information-form']['fc-student-ssn']
            );
        ...
        documentsA(template, data) {
          if (
            data.forms['personal-information-form']['fc-documents-a'] === 'yes'
          ) {
            template
              .font('Wingdings2')
              .fontSize(BIG_FONT_SIZE)
        ...
        documentsB(template, data) {
          if (
            data.forms['personal-information-form']['fc-documents-b'] === 'yes'
          ) {
            template
              .font('Wingdings2')
              .fontSize(BIG_FONT_SIZE)
        ...
        documentsC(template, data) {
          if (
            data.forms['personal-information-form']['fc-documents-c'] === 'yes'
          ) {
            template
              .font('Wingdings2')
              .fontSize(BIG_FONT_SIZE)
        ...
        documentsD(template, data) {
          if (
            data.forms['personal-information-form']['fc-documents-d'] === 'yes'
          ) {
            template
              .font('Wingdings2')
              .fontSize(BIG_FONT_SIZE)
        ...
        documentsE(template, data) {
          if (
            data.forms['personal-information-form']['fc-documents-e'] === 'yes'
          ) {
            template
              .font('Wingdings2')
              .fontSize(BIG_FONT_SIZE)
        ...
        documentsF(template, data) {
          if (
            data.forms['personal-information-form']['fc-documents-f'] === 'yes'
          ) {
            template
              .font('Wingdings2')
              .fontSize(BIG_FONT_SIZE)
        ...
        documentsG(template, data) {
          if (
            data.forms['personal-information-form']['fc-documents-g'] === 'yes'
          ) {
            template
              .font('Wingdings2')
              .fontSize(BIG_FONT_SIZE)
        ...
        tuitionPayment(template, data) {
          const text =
            data.forms['personal-information-form']['fc-tuition-payment'];
  ...
  templates: [
    {
      ...
      fields: {
        ...
        address(template, data) {
          ...
          const { address1 } = personalInformationForm;
          ...
          if (option === 2) {
            template
              ...
              .drawText(
                470,
                1634,
                data.forms['personal-information-form'].phone
              );
          }
      ...
      fields: {
        ...
        objection(template, data) {
          ...
          if (option === 2 || option === 3) {
            ...
            if (
              data.forms['personal-information-form']['tod-section2-option'] ===
              '1'
            ) {
              objection = '1';
            }
            ...
            template
              ...
              .drawText(
                382,
                3112,
                'I am requesting an in-person or telephone hearing because there are additional facts that I believe can \nonly be described in person or by phone.'
              );
          }
        },
        signature(template, data) {
...
const atbDisqualifyingDocument = {
  templates: [
    {
      path: '/lib/assets/document_templates/falsecert_disqualifying/0.png',
      ...
      fields: {
        ssn(template, data) {
          ...
          template
            .font('Arial')
            .fontSize(NORMAL_FONT_SIZE)
            .drawText(1436, 786, result[0])
            .drawText(1638, 786, result[1])
            .drawText(1788, 786, result[0]);
        },
        'personal-information-form.name': {
          x: 1432,
          y: 864,
        ...
        atbApplyingAs(template, data) {
          const value =
            data.forms['personal-information-form']['atbd-applying-as'];
        ...
        atbStudentName(template, data) {
          ...
          if (check === 'yes') {
            const value =
              data.forms['personal-information-form']['atbd-student-name'];

            template
              .font('Arial')
              .fontSize(NORMAL_FONT_SIZE)
              .drawText(306, 1942, value);
          }
        },
        atbStudentSsn(template, data) {
          const check =
          ...
          if (check === 'yes') {
            const result = normalizeSSN(
              data.forms['personal-information-form']['atbd-student-ssn']
            );

            template
              .font('Arial')
              .fontSize(NORMAL_FONT_SIZE)
              .drawText(310, 2090, result[0])
              .drawText(512, 2090, result[1])
              .drawText(662, 2090, result[2]);
          }
        },
        'personal-information-form.schoolName': {
          x: 306,
          y: 2244,
        },
        schoolAddress(template, data) {
          ...
          template
            .font('Arial')
            .fontSize(NORMAL_FONT_SIZE)
            .drawText(306, 2392, address)
            .drawText(306, 2444, address2);
        },
        schoolAttendance(template, data) {
          ...
          template
            .font('Arial')
            .fontSize(NORMAL_FONT_SIZE)
            .drawText(306, 2594, formatDate(_from))
            .drawText(706, 2594, formatDate(to));
        },
        'personal-information-form.atbd-program-of-study': {
          x: 306,
          y: 2918,
        },
        disqualifyReason(template, data) {
          const form = data.forms['personal-information-form'];

          const checkmark = template.font('Wingdings2').fontSize(BIG_FONT_SIZE);

          if (form['atbd-option1'] === 'yes') {
            checkmark.drawText(1468, 1784, 'P');
          }

          if (form['atbd-option2'] === 'yes') {
            checkmark.drawText(1468, 1834, 'P');
          }

          if (form['atbd-option3'] === 'yes') {
            checkmark.drawText(1468, 1884, 'P');
          }

          if (form['atbd-option4'] === 'yes') {
            checkmark.drawText(1468, 1934, 'P');
          }

          if (form['atbd-option5'] === 'yes') {
            checkmark.drawText(1468, 1984, 'P');

            template
              .font('Arial')
              .fontSize(NORMAL_FONT_SIZE)
              .drawText(1856, 1992, form['atbd-option5-text']);
          }
        },
        atbdLaw(template, data) {
          const form = data.forms['personal-information-form'];
          ...
          template
            .font('Arial')
            .fontSize(SMALL_FONT_SIZE)
            .drawText(1452, 2594, firstParagraph || '')
            .drawText(1452, 2644, secondParagraph || '');
        },
        reason(template, data) {
          const form = data.forms['personal-information-form'];
          ...
          if (form['atbd-reason-not-to-benefit'] === 'yes') {
            y = 2932;
          }
    ...
    {
      path: '/lib/assets/document_templates/falsecert_disqualifying/1.png',
      fields: {
        atbdInform(template, data) {
          const form = data.forms['personal-information-form'];

          if (form['atbd-reason-not-to-benefit'] === 'no') {
            const value = form['atbd-inform'];
        ...
        number16(template) {
          template
            .font('Wingdings2')
            .fontSize(BIG_FONT_SIZE)
            .drawText(1466, 1032, 'P');
        },
        signature(template, data) {
          const name = data.signature;
          const date = formatDate(new Date());

          template
            .font('Arial')
            .fontSize(NORMAL_FONT_SIZE)
            .drawText(576, 3016, name)
            .drawText(1852, 3016, date);
        },
      },
    },
    {
      path: '/lib/assets/document_templates/falsecert_disqualifying/2.png',
      fields: {},
    },
    {
      path: '/lib/assets/document_templates/falsecert_disqualifying/3.png',
      fields: {},
    },
  ],
};
