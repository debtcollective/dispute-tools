        ...
        objection(template, data) {
          ...
          if (option === 2 || option === 3) {
            ...
            template
              ...
              .drawText(382, 3126, 'I am requesting an in-person or telephone hearing because there are additional facts that I believe can only be described in person or by phone.');
          }
        },
        signature(template, data) {
          const date = new Date();
