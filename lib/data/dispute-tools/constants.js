  ...
  templates: [
    {
      ...
      fields: {
        ...
        option1(template, data) {
          if (data.forms['personal-information-form']['tod-section2-option1'] === 'yes') {
            template
              .font('Wingdings2')
              .fontSize(BIG_FONT_SIZE)
              .drawText(436, 2176, 'P');
...

    {
      ...
      fields: {
        option2(template, data) {
          if (data.forms['personal-information-form']['tod-section2-option2'] === 'yes') {
            template
              .font('Wingdings2')
              .fontSize(BIG_FONT_SIZE)
              .drawText(436, 552, 'P');
        ...
        option3(template, data) {
          if (data.forms['personal-information-form']['tod-section2-option3'] === 'yes') {
            const schoolName = data.forms['personal-information-form'].schoolName;
            const schoolFrom = data.forms['personal-information-form']['tod-school-attended-from'];
        ...
        option4(template, data) {
          if (data.forms['personal-information-form']['tod-section2-option4'] === 'yes') {
            template
              .font('Wingdings2')
              .fontSize(BIG_FONT_SIZE)
              .drawText(448, 1250, 'P');
        ...
        option5(template, data) {
          if (data.forms['personal-information-form']['tod-section2-option5'] === 'yes') {
            template
              .font('Wingdings2')
              .fontSize(BIG_FONT_SIZE)
              .drawText(448, 1466, 'P');
        ...
        option6(template, data) {
          if (data.forms['personal-information-form']['tod-section2-option6'] === 'yes') {
            template
              .font('Wingdings2')
              .fontSize(BIG_FONT_SIZE)
              .drawText(448, 1678, 'P');
